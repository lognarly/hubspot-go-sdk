...
func (z *companies) BatchCreate(options *CompanyBatchCreateOrUpdateOptions) (*CompanyBatchCreateOrUpdateResults, error) {
...
func (z *companies) BatchUpdate(options *CompanyBatchCreateOrUpdateOptions) (*CompanyBatchCreateOrUpdateResults, error) {
